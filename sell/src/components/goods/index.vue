					...
					<ul>
						<li v-for="food in item.foods" class="food-item border-1px" @click="selectFood(food,$event)">
							...
							<div class="content">
								...
								<div class="extra">
									<span v-text="'月售'+food.sellCount+'份'" class="count"></span><!--
								--><span v-text="'好评率'+food.rating"></span>
								</div>
								<div class="price">
									<span v-text="'￥'+food.price" class="now"></span><!--
								--><span v-if="food.oldPrice" v-text="'￥'+food.oldPrice" class="old"></span>
								</div>
    ...
    export default {
        ...
        methods: {
            ...
            selectMenu(index, event){
                if(!event._constructed){//判断是不是由BetterScroll发出的click事件
                    return;
                }
                let targetEl = this.$refs.foodsWrapper.getElementsByClassName('food-list-hook')[index];
                //让betterScroll滚动到指定位置且用动画执行300ms
                this.foodsScroll.scrollToElement(targetEl, 300);
            },
